-- 表结构（品牌表）
DROP TABLE IF EXISTS `seckill_demo_tb_brand`;
CREATE TABLE `seckill_demo_tb_brand`
(
  ...
  AUTO_INCREMENT = 325403
  DEFAULT CHARSET = utf8 COMMENT ='品牌表，一个品牌下有多个商品（spu），一对多关系';

-- 品牌表数据
INSERT INTO `seckill_demo_tb_brand`
VALUES ('8557', '华为（HUAWEI）',
        'http://img10.360buyimg.com/popshop/jfs/t5662/36/8888655583/7806/1c629c01/598033b4Nd6055897.jpg', 'H',
        '2019-02-27 22:54:12', '2019-02-27 22:54:29');

-- 表结构（类目表）
DROP TABLE IF EXISTS `seckill_demo_tb_category`;
CREATE TABLE `seckill_demo_tb_category`
(
...
-- 类目表数据
INSERT INTO `seckill_demo_tb_category`
VALUES ('74', '手机', '0', '1', '2', '2019-05-07 10:46:41', '2019-05-07 10:46:41');
INSERT INTO `seckill_demo_tb_category`
VALUES ('75', '手机通讯', '74', '1', '1', '2019-05-07 10:46:41', '2019-05-07 10:46:41');
INSERT INTO `seckill_demo_tb_category`
VALUES ('76', '手机', '75', '0', '1', '2019-05-07 10:46:41', '2019-05-07 10:46:41');


-- 表结构（类目品牌对应表）
DROP TABLE IF EXISTS `seckill_demo_tb_category_brand`;
CREATE TABLE `seckill_demo_tb_category_brand`
(
...
-- 类目品牌对应表数据
INSERT INTO `seckill_demo_tb_category_brand`
VALUES ('76', '8557');


-- 表结构（商品spu）
DROP TABLE IF EXISTS `seckill_demo_tb_spu`;
CREATE TABLE `seckill_demo_tb_spu`
(
...
INSERT INTO `seckill_demo_tb_spu`
VALUES ('2', '华为 G9 青春版 ',
        '骁龙芯片！3GB运行内存！索尼1300万摄像头！<a href=\'https://sale.jd.com/act/DhKrOjXnFcGL.html\' target=\'_blank\'>华为新品全面上线，更多优惠猛戳》》</a>',
        '74', '75', '76', '8557', '0', '2018-04-21 15:55:15', '2018-06-18 10:36:12');
INSERT INTO `seckill_demo_tb_spu`
VALUES ('69', '华为（HUAWEI） 华为P20pro 手机 ',
        '华为直供货源大量现货！【宝石蓝128G及极光色全系为预售请见详情】自带原装耳机 <a href=\"https://item.jd.com/26816294484.html\" target=\"_blank\">华为P20</a>',
        '74', '75', '76', '8557', '1', '2018-04-21 15:57:17', '2018-04-21 15:57:17');
INSERT INTO `seckill_demo_tb_spu`
VALUES ('94', '华为（HUAWEI） 华为P20 手机 ',
        '大量现货 华为直供货源！自带原装耳机 华为<a href=\"https://item.jd.com/26881279035.html\" target=\"_blank\">P20pro</a> 现货抢购！',
        '74', '75', '76', '8557', '1', '2018-04-21 15:58:22', '2018-04-21 15:58:22');

DROP TABLE IF EXISTS `seckill_demo_tb_spu_detail`;
CREATE TABLE `seckill_demo_tb_spu_detail`
(
...
INSERT INTO `seckill_demo_tb_spu_detail`
VALUES ('2',
        '<p><img src=\"//img20.360buyimg.com/vc/jfs/t5893/141/6838703316/1369626/15c9d88f/596c753aN075ee827.jpg\"></p>',
...
VALUES ('69',
        ...
        '本产品全国联保，享受三包服务，质保期为：一年质保', '2019-03-15 23:17:42', '2019-03-15 23:17:42');
INSERT INTO `seckill_demo_tb_spu_detail`
VALUES ('94',
...
-- 表结构（商品SKU）
DROP TABLE IF EXISTS `seckill_demo_tb_sku`;
CREATE TABLE `seckill_demo_tb_sku`
(
  ...
  AUTO_INCREMENT = 27359021564
  DEFAULT CHARSET = utf8 COMMENT ='sku表,该表表示具体的商品实体,如黑色的 64g的iphone 8';

-- 商品SKU数据
INSERT INTO `seckill_demo_tb_sku`
VALUES ('27359021557', '2', '华为 G9 青春版  白色 3GB 16GB',
        'https://img12.360buyimg.com/n7/jfs/t1/24205/2/14862/179077/5cb6d175E92733807/46e7ace99f41dd41.jpg', '9999',
        '84900', '0_0_0', '{\"4\":\"白色\",\"12\":\"3GB\",\"13\":\"16GB\"}', '1', '2019-03-18 22:09:49',
        '2019-03-18 22:09:49');
INSERT INTO `seckill_demo_tb_sku`
VALUES ('27359021558', '2', '华为 G9 青春版  金色 3GB 16GB',
        'https://img12.360buyimg.com/n7/jfs/t1/24205/2/14862/179077/5cb6d175E92733807/46e7ace99f41dd41.jpg', '9999',
        '84900', '1_0_0', '{\"4\":\"金色\",\"12\":\"3GB\",\"13\":\"16GB\"}', '1', '2019-03-18 22:09:49',
        '2019-03-18 22:09:49');
INSERT INTO `seckill_demo_tb_sku`
VALUES ('27359021559', '2', '华为 G9 青春版  玫瑰金 3GB 16GB',
        'https://img12.360buyimg.com/n7/jfs/t1/24205/2/14862/179077/5cb6d175E92733807/46e7ace99f41dd41.jpg', '9999',
        '84900', '2_0_0', '{\"4\":\"玫瑰金\",\"12\":\"3GB\",\"13\":\"16GB\"}', '1', '2019-03-18 22:09:49',
        '2019-03-18 22:09:49');
INSERT INTO `seckill_demo_tb_sku`
VALUES ('26816294479', '94', '华为（HUAWEI） 华为P20 手机 宝石蓝 高配（6G+128G）',
        'https://img10.360buyimg.com/n1/s450x450_jfs/t1/30693/17/7599/332089/5c98cc1fE43eafa3c/3b3515c7537efeaf.jpg',
        '9999', '428800', '1_0_0', '{\"4\":\"宝石蓝\",\"12\":\"6GB\",\"13\":\"64GB\"}', '1', '2018-04-21 15:58:21',
        '2018-04-21 15:58:21');
INSERT INTO `seckill_demo_tb_sku`
VALUES ('26816294480', '94', '华为（HUAWEI） 华为P20 手机 樱粉金 标配（6G+64G）',
        'https://img10.360buyimg.com/n1/s450x450_jfs/t1/30693/17/7599/332089/5c98cc1fE43eafa3c/3b3515c7537efeaf.jpg',
        '9999', '378800', '3_0_0', '{\"4\":\"樱粉金\",\"12\":\"6GB\",\"13\":\"64GB\"}', '1', '2018-04-21 15:58:22',
        '2018-04-21 15:58:22');
INSERT INTO `seckill_demo_tb_sku`
VALUES ('26816294483', '94', '华为（HUAWEI） 华为P20 手机 香槟金 高配（6G+128G）',
        'https://img10.360buyimg.com/n1/s450x450_jfs/t1/30693/17/7599/332089/5c98cc1fE43eafa3c/3b3515c7537efeaf.jpg',
        '9999', '428800', '2_0_0', '{\"4\":\"香槟金\",\"12\":\"6GB\",\"13\":\"64GB\"}', '1', '2018-04-21 15:58:21',
        '2018-04-21 15:58:21');
INSERT INTO `seckill_demo_tb_sku`
VALUES ('26881279026', '69', '华为（HUAWEI） 华为P20pro 手机 宝石蓝 6G+128G',
        'https://img10.360buyimg.com/n1/s450x450_jfs/t17689/292/1247919821/159809/1c87eb05/5ac1eae4Nce7c8b00.jpg',
        '9999', '548800', '0_0_0', '{\"4\":\"宝石蓝\",\"12\":\"6GB\",\"13\":\"128GB\"}', '1', '2018-04-21 15:57:15',
        '2018-04-21 15:57:15');
INSERT INTO `seckill_demo_tb_sku`
VALUES ('26881279030', '69', '华为（HUAWEI） 华为P20pro 手机 樱粉金 6G+256G',
        'https://img10.360buyimg.com/n1/s450x450_jfs/t17689/292/1247919821/159809/1c87eb05/5ac1eae4Nce7c8b00.jpg',
        '9999', '658800', '3_0_0', '{\"4\":\"樱粉金\",\"12\":\"6GB\",\"13\":\"128GB\"}', '1', '2018-04-21 15:57:17',
        '2018-04-21 15:57:17');
INSERT INTO `seckill_demo_tb_sku`
VALUES ('26881279032', '69', '华为（HUAWEI） 华为P20pro 手机 极光色 6G+128G',
        'https://img10.360buyimg.com/n1/s450x450_jfs/t17689/292/1247919821/159809/1c87eb05/5ac1eae4Nce7c8b00.jpg',
        '9999', '618800', '2_0_0', '{\"4\":\"极光色\",\"12\":\"6GB\",\"13\":\"128GB\"}', '1', '2018-04-21 15:57:16',
        '2018-04-21 15:57:16');
INSERT INTO `seckill_demo_tb_sku`
VALUES ('26881279035', '69', '华为（HUAWEI） 华为P20pro 手机 亮黑色 6G+128G',
        'https://img10.360buyimg.com/n1/s450x450_jfs/t17689/292/1247919821/159809/1c87eb05/5ac1eae4Nce7c8b00.jpg',
        '9999', '548800', '1_0_0', '{\"4\":\"亮黑色\",\"12\":\"6GB\",\"13\":\"128GB\"}', '1', '2018-04-21 15:57:16',
        '2018-04-21 15:57:16');

-- 表结构（规格参数的分组表）
DROP TABLE IF EXISTS `seckill_demo_tb_spec_group`;
CREATE TABLE `seckill_demo_tb_spec_group`
(
...
INSERT INTO `seckill_demo_tb_spec_group`
VALUES ('1', '76', '主体', '2019-03-13 22:14:13', '2019-03-13 22:14:13');
INSERT INTO `seckill_demo_tb_spec_group`
VALUES ('2', '76', '基本信息', '2019-03-13 22:14:13', '2019-03-13 22:14:13');
INSERT INTO `seckill_demo_tb_spec_group`
VALUES ('3', '76', '操作系统', '2019-03-13 22:14:13', '2019-03-13 22:14:13');
INSERT INTO `seckill_demo_tb_spec_group`
VALUES ('4', '76', '主芯片', '2019-03-13 22:14:13', '2019-03-13 22:14:13');
INSERT INTO `seckill_demo_tb_spec_group`
VALUES ('5', '76', '存储', '2019-03-13 22:14:13', '2019-03-13 22:14:13');
INSERT INTO `seckill_demo_tb_spec_group`
VALUES ('6', '76', '摄像头', '2019-03-13 22:14:13', '2019-03-13 22:14:13');
INSERT INTO `seckill_demo_tb_spec_group`
VALUES ('7', '76', '电池信息', '2019-03-13 22:14:13', '2019-03-13 22:14:13');
INSERT INTO `seckill_demo_tb_spec_group`
VALUES ('11', '76', '屏幕', '2019-03-13 22:14:13', '2019-03-13 22:14:13');
INSERT INTO `seckill_demo_tb_spec_group`
VALUES ('12', '90', '主体', '2019-03-13 22:14:13', '2019-03-13 22:14:13');
INSERT INTO `seckill_demo_tb_spec_group`
VALUES ('13', '90', '规格尺寸', '2019-03-13 22:14:13', '2019-03-13 22:14:13');
INSERT INTO `seckill_demo_tb_spec_group`
VALUES ('14', '77', 'test', '2019-03-13 22:14:13', '2019-03-13 22:14:13');

-- 表结构（规格参数表）
DROP TABLE IF EXISTS `seckill_demo_tb_spec_param`;
CREATE TABLE `seckill_demo_tb_spec_param`
(
    `id`          BIGINT(20)   NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('1', '76', '1', '品牌', '0', '', '1', '0', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('2', '76', '1', '型号', '0', '', '1', '0', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('3', '76', '1', '上市年份', '1', '年', '1', '0', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('4', '76', '2', '机身颜色', '0', '', '0', '0', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('5', '76', '2', '机身重量（g）', '1', 'g', '1', '0', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('6', '76', '2', '机身材质工艺', '0', '', '1', '0', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('7', '76', '3', '操作系统', '0', '', '1', '1', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('8', '76', '4', 'CPU品牌', '0', '', '1', '1', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('9', '76', '4', 'CPU型号', '0', '', '1', '0', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('10', '76', '4', 'CPU核数', '0', '', '1', '1', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('11', '76', '4', 'CPU频率', '1', 'GHz', '1', '1', '0-1.0,1.0-1.5,1.5-2.0,2.0-2.5,2.5-', '2019-03-13 22:15:13',
        '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('12', '76', '5', '内存', '0', '', '0', '1', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('13', '76', '5', '机身存储', '0', '', '0', '1', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('14', '76', '11', '主屏幕尺寸（英寸）', '1', '英寸', '1', '1', '0-4.0,4.0-5.0,5.0-5.5,5.5-6.0,6.0-', '2019-03-13 22:15:13',
        '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('15', '76', '11', '分辨率', '0', '', '1', '0', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('16', '76', '6', '前置摄像头', '1', '万', '1', '1', '0-500,500-1000,1000-1500,1500-2000,2500-', '2019-03-13 22:15:13',
        '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('17', '76', '6', '后置摄像头', '1', '万', '1', '1', '0-500,500-1000,1000-1500,1500-2000,2500-', '2019-03-13 22:15:13',
        '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('18', '76', '7', '电池容量（mAh）', '1', 'mAh', '1', '1', '0-2000,2000-3000,3000-4000,4000-', '2019-03-13 22:15:13',
        '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('19', '90', '12', '品牌', '0', '', '1', '0', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('20', '90', '12', '适用机型', '0', '', '0', '0', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('21', '90', '13', '贴膜尺寸', '1', '英寸', '1', '1', '0-4.0,4.0-5.0,5.0-5.5,5.5-6.0,6.0-', '2019-03-13 22:15:13',
        '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('22', '90', '13', '材质', '0', '', '1', '1', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');
INSERT INTO `seckill_demo_tb_spec_param`
VALUES ('23', '90', '13', '类型', '0', '', '1', '1', '', '2019-03-13 22:15:13', '2019-03-13 22:15:13');


-- 表结构（用户表）
DROP TABLE IF EXISTS `seckill_demo_tb_user`;
CREATE TABLE `seckill_demo_tb_user`
(
...
INSERT INTO `seckill_demo_tb_user`
VALUES ('28', 'zhangsan', 'e21d44f200365b57fab2641cd31226d4', '13600527633', '2019-04-04 22:58:26',
        '2019-04-04 22:58:26');


-- 表结构（订单表）
DROP TABLE IF EXISTS `seckill_demo_tb_order`;
CREATE TABLE `seckill_demo_tb_order`
(
...
-- 表结构（订单明细表）
DROP TABLE IF EXISTS `seckill_demo_tb_order_detail`;
CREATE TABLE `seckill_demo_tb_order_detail`
(
...
-- 表结构（订单物流表）
DROP TABLE IF EXISTS `seckill_demo_tb_order_logistics`;
CREATE TABLE `seckill_demo_tb_order_logistics`
(
...
-- 表结构（库房表）
DROP TABLE IF EXISTS `seckill_demo_tb_warehouse`;
CREATE TABLE `seckill_demo_tb_warehouse`
(
...
INSERT INTO `seckill_demo_tb_warehouse`
VALUES ('1', '北京库', '2019-04-04 22:58:26', '2019-04-04 22:58:26');

-- 表结构（库存主表）
DROP TABLE IF EXISTS `seckill_demo_tb_stock_storage`;
CREATE TABLE `seckill_demo_tb_stock_storage`
(
...
-- 表结构（库存明细表）
DROP TABLE IF EXISTS `seckill_demo_tb_stock_storage_history`;
CREATE TABLE `seckill_demo_tb_stock_storage_history`
(
    `id`               BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
INSERT INTO seckill_demo_tb_stock_storage
VALUES ('1', '1', '27359021557', '1000');
INSERT INTO seckill_demo_tb_stock_storage_history
VALUES ('1', '1', '1000', '0');

-- 表结构（购物车表）
DROP TABLE IF EXISTS `seckill_demo_tb_shoppingcart`;
CREATE TABLE `seckill_demo_tb_shoppingcart`
(
    `id`          BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
    `sku_id`      BIGINT(20) NOT NULL COMMENT 'skuid',
...
-- 表结构（秒杀政策表）
DROP TABLE IF EXISTS `seckill_demo_tb_limit_policy`;
CREATE TABLE `seckill_demo_tb_limit_policy`
(
    `id`            BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
    `sku_id`        BIGINT(20) NOT NULL COMMENT 'skuid',
